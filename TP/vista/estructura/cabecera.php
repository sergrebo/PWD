        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li><a class="dropdown-item" href="./vista/tp/1/ejercicio1.php">Ejercicio 1</a></li>
              <li><a class="dropdown-item" href="./vista/tp/1/ejercicio2.php">Ejercicio 2</a></li>
              <li><a class="dropdown-item" href="./vista/tp/1/ejercicio3.php">Ejercicio 3</a></li>
              <li><a class="dropdown-item" href="./vista/tp/1/ejercicio4.php">Ejercicio 4</a></li>
              <li><a class="dropdown-item" href="./vista/tp/1/ejercicio5.php">Ejercicio 5</a></li>
              <li><a class="dropdown-item" href="./vista/tp/1/ejercicio6.php">Ejercicio 6</a></li>
              <li><a class="dropdown-item" href="./vista/tp/1/ejercicio7.php">Ejercicio 7</a></li>
              <li><a class="dropdown-item" href="./vista/tp/1/ejercicio8.php">Ejercicio 8</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
