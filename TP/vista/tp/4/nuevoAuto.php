...
<main class="container">
  ...
  <form action="./accionNuevoAuto.php" method="post" id="formulario" class="novalidate col-6 mx-auto" novalidate>
    <div class="row">
      <div class="col mb-3 position-relative">
        <label for="dniDuenio" class="form-label">DNI del titular del vehículo</label>
        <div class="input-group">
          <input type="text" name="dniDuenio" id="dniDuenio" class="form-control" value="<?php echo isset($dni)? $dni : "" ?>" readonly>
          <a href="./elegirPersona.php?origen=nuevoAuto" class="input-group-text"><i class="bi bi-search"></i></a>
        </div>
      </div>
      <div class="col mb-3 position-relative">
